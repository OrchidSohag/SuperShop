...
@section('content')
    <div class="container" >
        ...
        <nav  class="navbar navbar-center navbar-expand-lg navbar-light bg-light">
                <form method="post" action="{{route('UpdateSaleForm')}}" class="form-inline my-2 my-lg-0">
                ...
                <form method="post" action="{{route('DeleteSale')}}" class="form-inline my-2 my-lg-0">
                    {{--<input class="form-control mr-sm-2" type="search" placeholder="Search">--}}
                    @csrf
                    <select name="id">
                        <option selected>Sale ID</option>
            ...
            <form method="post" action="{{route('SearchSale')}}" class="form-inline my-2 my-lg-0">
                    {{--<input class="form-control mr-sm-2" type="search" placeholder="Search">--}}
                    @csrf
                    <select name="id">
                        <option selected>Sale ID</option>
