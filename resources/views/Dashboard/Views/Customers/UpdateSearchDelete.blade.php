                    ...
                    <div class="page-header float-right">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                ...
                                <li class="active">Customers CRUD</li>
                            </ol>
                        </div>
                    </div>
                </div>
...
@section('content')
    <div class="container" >
        ...
        <nav  class="navbar navbar-center navbar-expand-lg navbar-light bg-light">
                <form method="post" action="{{route('UpdateCustomerForm')}}" class="form-inline my-2 my-lg-0">
                ...
                <form method="post" action="{{route('DeleteCustomer')}}" class="form-inline my-2 my-lg-0">
                    {{--<input class="form-control mr-sm-2" type="search" placeholder="Search">--}}
                    @csrf
                    <select name="id">
                        <option selected>Customer ID</option>
            ...
            <form method="post" action="{{route('SearchCustomer')}}" class="form-inline my-2 my-lg-0">
                    {{--<input class="form-control mr-sm-2" type="search" placeholder="Search">--}}
                    @csrf
                    <select name="id">
                        <option selected>Customer ID</option>
